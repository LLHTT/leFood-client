        ...
        <footer>
            <div className="footer-container">
                <form className="subscribe" onSubmit={subscribe}>
                    ...
                    {errorMessage && 
                        <div className="error-message">This email is already submitted. Please use another email!</div>
                    }
                    {successMessage && 
                        <div className="success-message">Thank you! You have successfully subscribed to us!</div>
                    }   
            ...
            <div className="footer-copyright">
                <p className="copyright-txt">&copy; leFood 2022. All Rights Reserved.</p>
            </div>
        </footer>
    ) 
}